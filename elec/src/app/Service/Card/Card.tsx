...
export default function Card(props:serviceProps) {
  ...
  return (
    <div className="relative flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg my-10 shadow-2xl  ">
      <div
      ...
      <div className="p-6 pt-0">
        ...
        onClick={()=>
          ...
          type="button"
          className="select-none rounded-lg bg-blue-500 py-3 px-6
