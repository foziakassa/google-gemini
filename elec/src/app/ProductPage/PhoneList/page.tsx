...
export default function ProductList({name , price  , imag , count}:any) {
 const [Count , setCount]= useState(0);
 const [Arr , setArr]=useState<Product[]>([])
 const [xx , setXx] =useState(true)
 function countHandler() {
  setCount((prev) => prev + 1);
  setArr([...Arr, {Name:name , Price:price }])
  setXx(false)
  console.log(Arr.map((item)=>item.Name))
    ...
    return (
      <div className="">
        ...
        <div className="w-full max-w-80 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:translate-y-0.5 ">
          <a href="#">
            <img
             className=" object-fill h-80  overflow-hidden" 
             src={imag.src} 
